...
void Init_Timer_2(void)
{
	...
	TIM2_TimeBaseStructure.TIM_Prescaler = 23; // frequency = 1000000
...
void Init_Timer_3(void)
{
	...
	TIM3_TimeBaseStructure.TIM_Prescaler = 23; // frequency = 1000000
	TIM3_TimeBaseStructure.TIM_Period = 1000 - 1;	//Count to 1000 and restart to count from 0, or timer event every 1ms
